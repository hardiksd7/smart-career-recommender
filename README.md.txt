# 🎯 Smart Career Path Recommender using Resume Parsing & Machine Learning

This is a solo Project developed using **Python**, **Machine Learning**, and **Streamlit**. The project aims to analyze an uploaded resume and recommend a suitable career path based on extracted skills using natural language processing (NLP) and a trained ML model.
